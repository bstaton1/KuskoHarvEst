...
**NOTE**: The first time you build a PDF report this way, the process will take quite a bit longer than every subsequent time. This is because the 'tinytex' R package must install the necessary extensions for TinyTex to work properly. You'll know this is happening because you'll see a lot of text popping up in the R console that talks about "tlmgr".
